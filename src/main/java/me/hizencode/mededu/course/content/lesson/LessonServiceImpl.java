...
public class LessonServiceImpl implements LessonService {
    ...
    @Override
    public List<CourseContentItemProjection> findAllByCourseIdOnlyIdAndTitleAndOrder(int courseId) {
        return lessonRepository.findAllByCourseIdOrderByOrderNumber(courseId, CourseContentItemProjection.class);
    }
